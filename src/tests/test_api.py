...
class TestAPIEndpoints:
    ...
    def test_predict_endpoint_success(self, client, valid_customer_data):
        ...
        with patch(
            ...
            mock_model_manager.is_loaded = (
                True  # Set is_loaded property directly
            )
    ...
    def test_metrics_endpoint(self, client):
        ...
        assert (
            ...
            or "prediction_requests_total" in response.text
        )
    ...
    def test_cors_headers(self, client):
        ...
        with patch(
            ...
            response = client.get("/health")
            # CORS headers added by FastAPI middleware
...
class TestAPIEndpointsComprehensive:
    ...
    def test_batch_predict_comprehensive(self, client, valid_customer_data):
...
class TestModelManager:
    ...
    def test_model_manager_initialization(self):
        ...
        # ModelManager may auto-load model if it exists, check if loaded
