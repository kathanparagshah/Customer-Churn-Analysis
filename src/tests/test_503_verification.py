...
# Add the project root to the path to import the app module
...
class Test503Verification:
    ...
    def test_predict_endpoint_503_when_model_not_loaded(
    ...
    def test_predict_endpoint_200_when_model_loaded(
        self, client, valid_customer_data
    ):
    ...
    def test_batch_predict_endpoint_503_when_model_not_loaded(
        self, client, valid_customer_data
    ):
        """Test /predict/batch endpoint returns 503 when model not loaded."""
        with patch(
            "app.services.model_manager.model_manager"
        ) as mock_model_manager:
            mock_model_manager.is_loaded = False
    ...
    def test_batch_predict_endpoint_200_when_model_loaded(
        self, client, valid_customer_data
    ):
